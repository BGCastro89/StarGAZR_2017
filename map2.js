...
function initialize() {
    var mapOptions = {
      zoom: 3,
      maxZoom: 17,
      center: new google.maps.LatLng(37.790319, -122.40014),
      scaleControl: true,
    ...
    google.maps.event.addListener(map, 'click', function(event) {
        ...
        lightpol_url = "http://stargazr.us-west-2.elasticbeanstalk.com/brightness?lat="+lat_selected+"&lng="+long_selected;
    });
    ...
    $( "#get-conditions-here" ).click(function() {
        $.get(darksky_url, function(weatherdata) {
            ...
            $("#precipProbability").html(   Math.round(100*precipProbability) + "%");
